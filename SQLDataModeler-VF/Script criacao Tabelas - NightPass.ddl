...
ALTER TABLE t_estgenmusical
    ADD CONSTRAINT t_egm_estabeleci_fk FOREIGN KEY ( t_estabeleci_est_codigo )
        REFERENCES t_estabeleci ( est_codigo );

ALTER TABLE t_estgenmusical
    ADD CONSTRAINT t_egm_genmusical_fk FOREIGN KEY ( t_genmusical_gmu_codigo )
