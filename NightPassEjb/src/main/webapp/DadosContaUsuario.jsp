...
<body>
  <section id='signUpContainer'>
    ...
    <form action="CadastroUsuarioServlet" method="post" id="signUpForm">
      ...
      <input required type="text" name="rgOrgaoEmissor" value="${PFisicalog.rgOrgaoEmissor}" id="rgEmitter" placeholder="Org�o emissor" maxlength="15">
      ...
      <input required type="tel" name="telCelular" value="${PFisicalog.telCelular}" placeholder="N�mero do celular" maxlength="15">
