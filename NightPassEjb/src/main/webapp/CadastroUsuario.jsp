...
<body>
  <section id='signUpContainer'>
    <form action="CadastroUsuarioServlet" method="post" id="signUpForm">
      ...
      <div id="buttonsConsumerOwner">
        <input type='radio' name='tipoUsuario' id='isConsumer'>
        <label for="isConsumer">Consumidor</label>
        <input type='radio' name='tipoUsuario' id='isOwner'>
        <label for="isOwner">Proprietário</label>
      </div>
